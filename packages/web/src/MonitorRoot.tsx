  ...
  return (
    <div className="screen:w-screen screen:h-screen overflow-x-hidden overflow-y-scroll">
      <main className="flex-1">
        <header className="bg-aws-squid-ink visible flex h-12 w-full items-center justify-between text-lg text-white print:hidden">
        ...
        <div
          className={`fixed -left-64 top-0 z-50 transition-all ${
        ...
        <div
          ...
          className={`${isOpenDrawer ? 'visible' : 'invisible'}`}>
          <div
        ...
        <div className={`text-aws-font-color ${isOpenDrawer ? 'ml-64' : ''}`}>
